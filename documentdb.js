// v1 Carry over from older projects but significantly modifying so
// don't assume this is similar to the other documentdb.js that you'll see
...
function queryCollection(serviceUrl, channelId, user_id) {
    ...
    return new Promise((resolve, reject) => {
        var query = 'SELECT r.concur_token, r.google_id, r.google_last_mail_id, r.google_auth, r.bot_id, r.id FROM root r WHERE r.bot_id.address.user.id = "' + user_id + '"';
